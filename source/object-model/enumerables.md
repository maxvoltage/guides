...
[MutableArray](https://emberjs.com/api/ember/3.0/classes/MutableArray) API. The most common
...
reference documentation.](https://emberjs.com/api/ember/3.0/classes/MutableArray)

### Iterating Over an Enumerable

To enumerate all the values of an enumerable object, use the [`forEach()`](https://emberjs.com/api/ember/3.0/classes/MutableArray/methods/forEach?anchor=forEach)
method:
...
All enumerables expose [`firstObject`](https://emberjs.com/api/ember/3.0/classes/MutableArray/properties/firstObject?anchor=firstObject) and [`lastObject`](https://emberjs.com/api/ember/3.0/classes/MutableArray/properties/lastObject?anchor=lastObject) properties
...
[`map()`](https://emberjs.com/api/ember/3.0/classes/MutableArray/methods/map?anchor=map) method, which creates a new array with results of calling a
...
If your enumerable is composed of objects, there is a [`mapBy()`](https://emberjs.com/api/ember/3.0/classes/MutableArray/methods/mapBy?anchor=mapBy)
...
For arbitrary filtering, use the [`filter()`](https://emberjs.com/api/ember/3.0/classes/MutableArray/methods/filter?anchor=filter) method.  The filter method
...
When working with a collection of Ember objects, you will often want to filter a set of objects based upon the value of some property. The [`filterBy()`](https://emberjs.com/api/ember/3.0/classes/MutableArray/methods/filterBy?anchor=filterBy) method provides a shortcut.
...
containing all of the matched values, you can use [`find()`](https://emberjs.com/api/ember/3.0/classes/MutableArray/methods/find?anchor=find) and [`findBy()`](https://emberjs.com/api/ember/3.0/classes/MutableArray/methods/findBy?anchor=findBy),
...
use the [`every()`](https://emberjs.com/api/ember/3.0/classes/MutableArray/methods/every?anchor=every) method:
...
you can use the [`any()`](https://emberjs.com/api/ember/3.0/classes/MutableArray/methods/any?anchor=any) method:
